...
function RepositoriesTab() {
  return (
    <Container>
      ...
      <ToggleSwitch label="Show Repository Icon" storageKey={KeyRepoShowRepoIcon} />
      <ToggleSwitch label="Truncate Description" storageKey={KeyRepoTruncateDesc} />
      <ToggleSwitch label="No Description Marked" storageKey={KeyRepoShowNoDesc} />
      ...
      <ToggleSwitch label="Hide Help Wanted" storageKey={KeyRepoHideHelpWanted} />
    </Container>
  );
}
